...
#> Error in profile_register("standard", standard): Profile 'standard' already exists. Use overwrite = TRUE to replace.
...
#> Error in profile_register("gpu", gpu): Profile 'gpu' already exists. Use overwrite = TRUE to replace.
