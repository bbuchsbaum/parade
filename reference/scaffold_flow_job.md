...
#>   - /tmp/RtmpNuRaxT/scripts/my_job_submit.R
#>   - /tmp/RtmpNuRaxT/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpNuRaxT/scripts/my_job_status.R
#>   - /tmp/RtmpNuRaxT/scripts/my_job_collect.R
#>   - /tmp/RtmpNuRaxT/scripts/my_job_cancel.sh
# }
```
