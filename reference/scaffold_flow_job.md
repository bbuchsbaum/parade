...
#>   - /tmp/RtmpMmyPNK/scripts/my_job_submit.R
#>   - /tmp/RtmpMmyPNK/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpMmyPNK/scripts/my_job_status.R
#>   - /tmp/RtmpMmyPNK/scripts/my_job_collect.R
#>   - /tmp/RtmpMmyPNK/scripts/my_job_cancel.sh
# }
```
