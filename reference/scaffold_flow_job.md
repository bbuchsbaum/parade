...
#>   - /tmp/RtmpXBiAfs/scripts/my_job_submit.R
#>   - /tmp/RtmpXBiAfs/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpXBiAfs/scripts/my_job_status.R
#>   - /tmp/RtmpXBiAfs/scripts/my_job_collect.R
#>   - /tmp/RtmpXBiAfs/scripts/my_job_cancel.sh
# }
```
