...
#>   - /tmp/RtmpJzDkY3/scripts/my_job_submit.R
#>   - /tmp/RtmpJzDkY3/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpJzDkY3/scripts/my_job_status.R
#>   - /tmp/RtmpJzDkY3/scripts/my_job_collect.R
#>   - /tmp/RtmpJzDkY3/scripts/my_job_cancel.sh
# }
```
