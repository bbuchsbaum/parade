...
#>   - /tmp/RtmpvaC14h/scripts/my_job_submit.R
#>   - /tmp/RtmpvaC14h/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpvaC14h/scripts/my_job_status.R
#>   - /tmp/RtmpvaC14h/scripts/my_job_collect.R
#>   - /tmp/RtmpvaC14h/scripts/my_job_cancel.sh
# }
```
