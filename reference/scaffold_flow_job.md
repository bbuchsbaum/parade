...
#>   - /tmp/Rtmp8TJRoF/scripts/my_job_submit.R
#>   - /tmp/Rtmp8TJRoF/scripts/my_job_sbatch.sh
#>   - /tmp/Rtmp8TJRoF/scripts/my_job_status.R
#>   - /tmp/Rtmp8TJRoF/scripts/my_job_collect.R
#>   - /tmp/Rtmp8TJRoF/scripts/my_job_cancel.sh
# }
```
