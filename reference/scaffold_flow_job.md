...
#>   - /tmp/RtmpdVBnuX/scripts/my_job_submit.R
#>   - /tmp/RtmpdVBnuX/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpdVBnuX/scripts/my_job_status.R
#>   - /tmp/RtmpdVBnuX/scripts/my_job_collect.R
#>   - /tmp/RtmpdVBnuX/scripts/my_job_cancel.sh
# }
```
