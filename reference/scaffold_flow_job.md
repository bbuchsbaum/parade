...
#>   - /tmp/RtmpfPLhwl/scripts/my_job_submit.R
#>   - /tmp/RtmpfPLhwl/scripts/my_job_sbatch.sh
#>   - /tmp/RtmpfPLhwl/scripts/my_job_status.R
#>   - /tmp/RtmpfPLhwl/scripts/my_job_collect.R
#>   - /tmp/RtmpfPLhwl/scripts/my_job_cancel.sh
# }
```
