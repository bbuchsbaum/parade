...
#> 
#> Job name:  test_job 
#> Registry directory: /tmp/RtmpXBiAfs/parade-registry/test_job (would be created)
#> 
#> Log files that would be created:
#>   Output: /tmp/RtmpXBiAfs/parade-registry/test_job/logs/test_job.out
#>   Error: /tmp/RtmpXBiAfs/parade-registry/test_job/logs/test_job.err
#> 
