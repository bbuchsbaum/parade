...
#> 
#> Job name:  test_job 
#> Registry directory: /tmp/RtmpPgNTUD/parade-registry/test_job (would be created)
#> 
#> Log files that would be created:
#>   Output: /tmp/RtmpPgNTUD/parade-registry/test_job/logs/test_job.out
#>   Error: /tmp/RtmpPgNTUD/parade-registry/test_job/logs/test_job.err
#> 
