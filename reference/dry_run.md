...
#> 
#> Job name:  test_job 
#> Registry directory: /tmp/RtmpPM85UN/parade-registry/test_job (would be created)
#> 
#> Log files that would be created:
#>   Output: /tmp/RtmpPM85UN/parade-registry/test_job/logs/test_job.out
#>   Error: /tmp/RtmpPM85UN/parade-registry/test_job/logs/test_job.err
#> 
