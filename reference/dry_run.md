...
#> 
#> Job name:  test_job 
#> Registry directory: /tmp/RtmpvaC14h/parade-registry/test_job (would be created)
#> 
#> Log files that would be created:
#>   Output: /tmp/RtmpvaC14h/parade-registry/test_job/logs/test_job.out
#>   Error: /tmp/RtmpvaC14h/parade-registry/test_job/logs/test_job.err
#> 
