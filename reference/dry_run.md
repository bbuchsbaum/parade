...
#> 
#> Job name:  test_job 
#> Registry directory: /tmp/RtmpdVBnuX/parade-registry/test_job (would be created)
#> 
#> Log files that would be created:
#>   Output: /tmp/RtmpdVBnuX/parade-registry/test_job/logs/test_job.out
#>   Error: /tmp/RtmpdVBnuX/parade-registry/test_job/logs/test_job.err
#> 
