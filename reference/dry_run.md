...
#> 
#> Job name:  test_job 
#> Registry directory: /tmp/RtmpUllyCd/parade-registry/test_job (would be created)
#> 
#> Log files that would be created:
#>   Output: /tmp/RtmpUllyCd/parade-registry/test_job/logs/test_job.out
#>   Error: /tmp/RtmpUllyCd/parade-registry/test_job/logs/test_job.err
#> 
