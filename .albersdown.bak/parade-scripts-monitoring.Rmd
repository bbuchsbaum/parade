...
vignette: '%\VignetteIndexEntry{10. SLURM Scripts: submission and monitoring} %\VignetteEngine{knitr::rmarkdown}
...
```r
library(parade)
paths_init()  # Sets up your data/artifact/registry roots so parade can resolve aliases like registry://
