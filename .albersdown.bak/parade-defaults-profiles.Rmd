...
vignette: |
  %\VignetteIndexEntry{9. SLURM Profiles: Managing Multiple Job Types} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
params:
  family: red
css: albers.css
resource_files:
...
1. The current R session via the `parade.slurm.defaults` option so subsequent `slurm_resources()` calls in the same session see the changes immediately.
