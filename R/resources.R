...
#'
#' @param partition,time,nodes,ntasks,ntasks_per_node,cpus_per_task,ncpus,mem,account,qos,modules,omp_num_threads Various resource fields.
#' @return Named list suitable for batchtools' `submitJobs(resources=...)` and the template.
#' @export
