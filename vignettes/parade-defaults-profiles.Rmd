...
test_job <- submit_slurm("test.R", 
  resources = list(partition = "debug", time = "30m", cpus = 4, mem = "8G"))

# Full analysis with 1000 samples - needs 8 hours, 32 CPUs  
prod_job <- submit_slurm("full_analysis.R",
  resources = list(partition = "compute", time = "8h", cpus = 32, mem = "64G"))

# GPU model training - needs 12 hours, 2 GPUs
gpu_job <- submit_slurm("train_model.R",
  resources = list(partition = "gpu", time = "12h", cpus = 16, mem = "32G", gres = "gpu:2"))
```
...
slurm_defaults_set(partition = "debug", time = "30m", cpus = 4, mem = "8G", 
                   profile = "testing", persist = TRUE)

slurm_defaults_set(partition = "compute", time = "8h", cpus = 32, mem = "64G",
                   profile = "production", persist = TRUE)

slurm_defaults_set(partition = "gpu", time = "12h", cpus = 16, mem = "32G", gres = "gpu:2",
...
slurm_defaults_set(time = "8h", cpus = 32, profile = "standard", persist = TRUE)
...
# Results in: time = "24h", cpus = 32 (from profile)
...
# Results in: time = "2h", mem = "128G", cpus = 32 (from profile)
```
