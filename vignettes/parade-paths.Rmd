...
vignette: |
  %\VignetteIndexEntry{3. Smart Path Management: Write Once, Run Anywhere} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
params:
  family: red
css: albers.css
resource_files:
...
> Note: Code evaluation is disabled in this vignette to keep builds fast and
> environment-agnostic. Copy code into an interactive R session to run locally
> or on your cluster.
...
To make the configuration easy to reuse in SLURM scripts, you can also generate
shell exports:
